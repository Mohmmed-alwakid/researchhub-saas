...
export default async function handler(req, res) {
  ...
  console.log('🎯 Study Sessions API Request:', {
    method: req.method,
    url: req.url,
    hasAuth: !!authHeader,
...
async function updateSessionProgress(req, res, supabase, currentUser) {
  try {
    ...
    console.log('✅ Session progress updated:', sessionId);
...
async function getUserSessions(req, res, supabase, currentUser) {
  try {
    ...
    console.log('✅ User sessions retrieved:', sessions.length);
...
async function getStudySessions(req, res, supabase, currentUser, queryParams) {
  try {
    ...
    console.log('✅ Study sessions retrieved:', sessions.length);
