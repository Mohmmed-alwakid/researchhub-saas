  ...
  const handleExportTemplate = () => {
    try {
      const exportData = {
        ...
        exportedBy: 'ResearchHub Template Creation UI',
        version: '1.0.0'
      };
      ...
      link.href = url;
      link.download = `${template.title || 'template'}.json`;
  ...
  const handleImportTemplate = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (e) => {
      try {
        ...
        if (!importedData.title || !importedData.blocks || !Array.isArray(importedData.blocks)) {
        ...
        setTemplate(prev => ({
          ...
          metadata: {
            ...
            author: 'Current User', // Reset author
            version: '1.0.0',
            isPublic: false
          }
        }));
