...
export const GoogleOAuthButton: React.FC<GoogleOAuthButtonProps> = ({
  ...
  const handleGoogleAuth = async () => {
    ...
    try {
      ...
      // The actual authentication will be handled by the callback page
  ...
  return (
    <Button
      type="button"
      variant="outline"
      className={`w-full flex items-center justify-center gap-3 py-3 px-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors ${className}`}
