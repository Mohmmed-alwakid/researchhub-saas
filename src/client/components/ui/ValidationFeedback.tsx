...
// Individual feedback components for specific use cases
export const ErrorFeedback: React.FC<{ message: string; onDismiss?: () => void }> = ({ message, onDismiss }) => (
...
export const WarningFeedback: React.FC<{ message: string; onDismiss?: () => void }> = ({ message, onDismiss }) => (
...
export const InfoFeedback: React.FC<{ message: string; onDismiss?: () => void }> = ({ message, onDismiss }) => (
...
export const SuccessFeedback: React.FC<{ message: string; onDismiss?: () => void }> = ({ message, onDismiss }) => (
...
// Export ValidationMessage type for compatibility
export type ValidationMessage = ValidationMessageProps;
