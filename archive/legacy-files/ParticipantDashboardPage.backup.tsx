...
import { TransactionHistory } from '../../components/wallet/TransactionHistory';
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {/* Wallet Overview - Full width on mobile, 2 columns on large screens */}
        ...
        )}licationsService } from '../../services/participantApplications.service';
import type { IParticipantApplication } from '../../../shared/types';
import { WalletOverview } from '../../components/wallet/WalletOverview';
import { WithdrawalForm } from '../../components/wallet/WithdrawalForm';
import { WithdrawalHistory } from '../../components/wallet/WithdrawalHistory';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">
                {currentView === 'applications' ? 'My Applications' : 'My Wallet'}
              </h1>
        ...
        {/* Stats Cards - Show for both views but different content */}
        {currentView === 'applications' ? (
