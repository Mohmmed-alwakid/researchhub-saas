...
const routeModules = [
  ...
  { name: 'feedback', path: './dist/server/server/routes/feedback.routes.js' },
  { name: 'payment', path: './dist/server/server/routes/payment.routes.js' },
  { name: 'recording', path: './dist/server/server/routes/recording.routes.js' }
];
